		...
		<div class="row">
			<div class="col-xs-12">
				<div class="card card-info">
					...
					<?php
					if (isset($asg_data_id)){
						foreach($asg_data_id as $row){
							?>
					<div class="card-body">
						<form class="form-horizontal" method="post" action="<?php echo site_url('assignments/update_assign')?>">
							<div class="col-sm-6">
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">Assign ID </label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="asg_id" value="<?php echo $row->asg_id; ?>" readonly>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="date" class="form-control" name="complaint_date" value="<?php echo $row->complaint_date; ?>" required>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="support_by" value="<?php echo $row->support_by; ?>" readonly>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="stat_id" class="form-text" data-placeholder=" = Select Status = " style="width:100%;">
											<?php if (isset($stat_data_id)){ foreach($stat_data_id as $row){ ?>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="date" class="form-control" name="service_start" value="<?php echo $row->service_start; ?>" required>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="date" class="form-control" name="service_end" value="<?php echo $row->service_end; ?>" required>
									</div>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group">
									...
									<div class="col-sm-11">
										<textarea class="form-control" rows="3" name="complaints" required><?php echo $row->complaints; ?></textarea>
									</div>
								</div>
							</div>
							<div class="col-sm-12">
