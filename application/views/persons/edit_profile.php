		...
		<div class="row">
			<div class="col-xs-12">
				<div class="card card-info">
					...
					?>
					<div class="card-body">
						<form class="form-horizontal" method="post" action="<?php echo site_url('persons/update_profile')?>">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<a href="<?php echo site_url('persons/profile')?>" class="btn btn-default" ><i class="icon fa fa-remove"></i> Cancel</a>
