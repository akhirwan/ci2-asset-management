				...
				<div class="card card-info">
					<div class="card-header">
						<div class="card-title">
							<div class="title">Add new Level : <?php echo $lvl_kd; ?></div>
						</div>
					</div>
					<div class="card-body">
						<form class="form-inline" method="post" action="<?php echo site_url('levels/add_lvl')?>">
							<input type="hidden" class="form-control" name="lvl_id" value="<?php echo $lvl_kd; ?>" readonly>
								...
								?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('levels/del_lvl/'.$row->lvl_id);?>" class="btn btn-sm btn-danger" onclick="return confirm('Anda yakin?')" >
